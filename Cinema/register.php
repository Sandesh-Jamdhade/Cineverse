...
::-webkit-scrollbar-thumb{
    ...
    <!-- Header code ends here -->
        ...
        <div class="row">
            ...
            <center> <h3 class=" text-center"  style="color:black;">User Registration Form</h3></center>
            ...
            <div class="form-group">
                ...
                <button class="btn btn-success" type="submit" name="register">Register</button><br>
            </form>
            </div>
        </div>
        <br>
